...
public class ComThumbnailUtils {
    ...
    public static Bitmap extractThumbnail(Bitmap source, int width, int height) {
        return android.media.ThumbnailUtils.extractThumbnail(source, width, height);
//        return android.media.ThumbnailUtils.extractThumbnail(source, width, height, OPTIONS_NONE);
    }
